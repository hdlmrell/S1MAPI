...
namespace MAPI.Building
{
    ...
    /// </summary>
    /// <example>
    /// var building = new SemanticBuildingBuilder("MyShop")
    ...
    ///     .Build();
    /// </example>
    public sealed class SemanticBuildingBuilder
    {
        #region Fields
        ...
        public SemanticBuildingBuilder(string name)
        {
            _name = name;
        ...
        public SemanticBuildingBuilder WithConfig(BuildingConfig config)
        {
            _config = config;
        ...
        /// <returns>This builder for chaining</returns>
        public SemanticBuildingBuilder WithPalette(BuildingPalette palette)
        {
        ...
        /// <returns>This builder for chaining</returns>
        public SemanticBuildingBuilder AddFloor(Color? color = null, Material? material = null)
        {
        ...
        /// <param name="material">Optional material override</param>
        /// <returns>This builder for chaining</returns>
        public SemanticBuildingBuilder AddCeiling(Color? color = null, Material? material = null)
        {
        ...
        /// <param name="material">Optional material override</param>
        /// <returns>This builder for chaining</returns>
        public SemanticBuildingBuilder AddRoofTrim(float height = 0.3f, Material? material = null)
        {
        ...
        /// <param name="material">Optional material override</param>
        /// <returns>This builder for chaining</returns>
        public SemanticBuildingBuilder AddCornerPillars(float width = 0.4f, Material? material = null)
        {
        ...
        /// <returns>This builder for chaining</returns>
        public SemanticBuildingBuilder AddFoundation(float height = 2.0f, float expandX = 0f, float expandZ = 0f)
        {
        ...
        /// <returns>This builder for chaining</returns>
        public SemanticBuildingBuilder AddLights(float? intensity = null, Color? color = null)
        {
        ...
        /// <returns>This builder for chaining</returns>
        public SemanticBuildingBuilder AddAmbientLighting(float intensity = 0.3f)
        {
        ...
        /// <param name="color">Optional color override</param>
        /// <returns>This builder for chaining</returns>
        public SemanticBuildingBuilder AddFurniture(FurnitureType type, string position, Color? color = null)
        {
        ...
        /// <param name="color">Optional color override</param>
        /// <returns>This builder for chaining</returns>
        public SemanticBuildingBuilder AddFurniture(FurnitureType type, Vector3 position, Quaternion rotation, Color? color = null)
        {
        ...
        /// <param name="rotation">Local rotation</param>
        /// <returns>This builder for chaining</returns>
        public SemanticBuildingBuilder AddPrefab(PrefabRef prefab, Vector3 position, Quaternion rotation)
        {
        ...
        /// <returns>This builder for chaining</returns>
        public SemanticBuildingBuilder AddSlidingDoors(Vector3 position, Quaternion rotation, string openingHours = "6AM-6PM")
        {
        ...
        public GameObject Build()
        {
            ...
            DebugLog.Info($"[SemanticBuildingBuilder] Built '{_name}' ({_roomSize.x}x{_roomSize.y}x{_roomSize.z}m)");
            return _root;
        }
